...
export const t = {
  ...
  parlamento: {
    ...
    commissioni: {
      ...
      filterNoMatch: 'Nessuna commissione ha questo nome.',
      tryFullText: (q: string) =>
        `Cerca "${q}" nelle trascrizioni delle commissioni →`,
      ...
      yearAll: 'Tutti gli anni',
      legFilterAll: 'Tutte le legislature',
      kindAll: 'Tutti i tipi di seduta',
      onlyWithText: 'Solo con trascrizione',
      sortNewest: 'Più recenti',
      sortOldest: 'Cronologico',
      resetFilters: 'Azzera filtri',
      filtersLegend: 'Filtra le sedute',
      rosterFiltersLegend: 'Filtra le commissioni',
      typeAll: 'Stenografici e sommari',
      typeSteno: 'Solo stenografici',
      typeSommario: 'Solo sommari',
      onlyWithTextRoster: 'Solo con trascrizioni',
      sortBy: 'Ordina per',
      sortSedute: 'Più sedute',
      sortRecenti: 'Attività più recente',
      sortNome: 'Nome',
      sortInterventi: 'Più interventi',
    },
    reader: {
      fontLabel: 'Carattere',
